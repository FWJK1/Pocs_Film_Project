...
## Read in Dataframe 
df = pd.read_csv(f"{root}/Data/2020_trope_data/letterboxd_search.csv")


## run the function ##
get_Movies_all(
    df, chunk_size=50, begin=int(input("Enter Begin Line: ")), length=None,
    sleeptime=0, output_file=f'{root}/Data/2020_trope_data/HIT_letterboxd_link_movies.csv',
    missed_output_file=f'{root}/Data/2020_trope_data/MISSED_letterboxd_link_movies.csv',
)
print("Movies linked.")
